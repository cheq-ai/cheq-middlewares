...
function rtiRequestBuilder(req, eventType, params) {
	...
	console.log('[rtiRequestBuilder] Built params:', reqParams);
	return reqParams;
}
...
function rtiRequestBuilderV4(req, eventType, params) {
	...
	// Initialze rti-v4 request object
	const reqParams = {
		[rtiParams.TAG_HASH]: undefined,
		[rtiParams.API_KEY]: undefined,
	...
	switch (params.sessionSyncMode) {
	case 'rtiCookie': {
		console.log('[rtiRequestBuilderV4] sessionSyncMode: rtiCookie');
		reqParams['duidCookie'] = req.headers.duidCookie;
		reqParams['pvidCookie'] = req.headers.pvidCookie;
		break;
	}
	case 'requestId': {
		console.log('[rtiRequestBuilderV4] sessionSyncMode: requestId');
		reqParams['pageViewId'] = req.headers.pageViewId;
		reqParams['clientUserId'] = req.headers.clientUserId;
		break;
	}
	default: { // none - send all
		console.log('[rtiRequestBuilderV4] sessionSyncMode: default');
		reqParams['pageViewId'] = req.headers.pageViewId;
		reqParams['clientUserId'] = req.headers.clientUserId;
		reqParams['duidCookie'] = req.headers.duidCookie;
		reqParams['pvidCookie'] = req.headers.pvidCookie;
	...
	console.log('[rtiRequestBuilderV4] Built params:', reqParams);
	return reqParams;
}
