...
function rtiRequestBuilderV4(req, eventType, params) {
	...
	const duid       = req.identifiers.duid;
	const duidCookie = req.identifiers.duidcookie;
	const pageViewId = req.identifiers.pageviewid;
	const pvidCookie = req.identifiers.pvidCookie;
	...
	case 'ip_useragent': {
		...
		reqParams.endUserParams.headers = req.identifiers;
