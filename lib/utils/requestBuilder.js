...
function rtiRequestBuilder(req, eventType, params) {
	...
	reqParams[rtiParams.RESOURCE_TYPE] = params.resourceType || 'text/html';
	...
	reqParams[rtiParams.JA3] = typeof params.getJa3 === 'function' ? params.getJa3(req) : undefined;
	reqParams[rtiParams.CHANNEL] = typeof params.getChannel === 'function' ? params.getChannel(req) : undefined;
